...
def parse_execution(data, file_names):
    ...
    coleta.chave_coleta = IDColeta("mpt", MONTH, YEAR)
    coleta.orgao = "mpt"
    coleta.mes = int(MONTH)
    coleta.ano = int(YEAR)
    coleta.repositorio_coletor = "https://github.com/dadosjusbr/coletor-mpt"
    coleta.versao_coletor = CRAWLER_VERSION
    coleta.repositorio_parser = "https://github.com/dadosjusbr/parser-mpt"
